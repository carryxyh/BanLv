...
public class NetLocationActivity extends Activity implements
	...
	public void onLocationChanged(AMapLocation amapLocation) {
		...
		if (amapLocation != null
			...
			mLocationCountryTextView.setText(amapLocation.getCity());
			...
			mLocationRoadTextView.setText(amapLocation.getStreet());
			mLocationPOITextView.setText(amapLocation.getPoiId());
